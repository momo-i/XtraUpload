	...
	$('#file_list_table').append(""+
		"<tr id='"+file.id+"'>"+
			"<td class='align-left' style='vertical-align:middle'>"+
				"<img class='nb' src='"+___baseUrl()+"assets/images/files/"+___getFileIcon(file.type.toLowerCase())+".png' border='0'>&nbsp;" +
				file.name +
			"</td>"+
			"<td id='"+file.id+"-del'>"+
				"<img id='"+file.id+"-edit_img' onclick=\"$('#"+file.id+"-details').show();$(this).fadeOut('fast')\" src='"+___baseUrl()+"assets/images/icons/edit_16.png' title='Edit File Details' style='cursor:pointer' class='nb'>&nbsp;"+
				"<img onclick=\"rm_file('" + file.id + "');\" src='"+___baseUrl()+"assets/images/icons/close_16.png' style='cursor:pointer' class='nb'>"+
			"</td>"+
		"</tr>"+
