...
$lang['Manage Files in Folder'] = 'Manage Files in Folder';
...
$lang['Search Files'] = 'Search Files';

#: application/controllers/admin/files.php:222
$lang['File Edited'] = 'File Edited';
...
$lang['File Banned'] = 'File Banned';

#: application/controllers/admin/files.php:297
$lang['%d File(s) have been Banned'] = '%d File(s) have been Banned';

#: application/controllers/admin/files.php:319
$lang['%d Files(s) have been deleted'] = '%d Files(s) have been deleted';

#: application/controllers/admin/folders.php:60
$lang['File Folder Manager'] = 'File Folder Manager';

#: application/controllers/admin/folders.php:75
$lang['Search File Folder'] = 'Search File Folder';

#: application/controllers/admin/folders.php:93
$lang['File Folder Search Results'] = 'File Folder Search Results';

#: application/controllers/admin/folders.php:103
$lang['Folder Deleted!'] = 'Folder Deleted!';

#: application/controllers/admin/gateways.php:62
$lang['Manage Payment Gateways'] = 'Manage Payment Gateways';
...
$lang['Payment Gateway Edited!'] = 'Payment Gateway Edited!';

#: application/controllers/admin/gateways.php:124
$lang['New Payment Gateway Set as Default!'] = 'New Payment Gateway Set as Default!';

#: application/controllers/admin/gateways.php:133
$lang['Payment Gateway turned on!'] = 'Payment Gateway turned on!';

#: application/controllers/admin/gateways.php:142
$lang['Payment Gateway turned off!'] = 'Payment Gateway turned off!';
...
$lang['Can Access Admin Panel?'] = 'Can Access Admin Panel?';

#: application/controllers/admin/group.php:166
$lang['Allow Search Access'] = 'Allow Search Access';

#: application/controllers/admin/group.php:167
$lang['Download speed limit'] = 'Download speed limit';

#: application/controllers/admin/group.php:168
$lang['File Size Limit'] = 'File Size Limit';

#: application/views/default/user/compare.php:13
$lang['Download Wait Time'] = 'Download Wait Time';

#: application/controllers/admin/group.php:170
$lang['File Types'] = 'File Types';

#: application/controllers/admin/group.php:171
$lang['File Types are Allowed/Restricted'] = 'File Types are Allowed/Restricted';

#: application/controllers/admin/group.php:172
$lang['Captcha for downloads'] = 'Captcha for downloads';

#: application/views/default/user/compare.php:15
$lang['Direct Links?'] = 'Direct Links?';

#: application/controllers/admin/group.php:174
$lang['Mass Upload File Count'] = 'Mass Upload File Count';

#: application/controllers/admin/group.php:175
$lang['Account Storage Limit'] = 'Account Storage Limit';

#: application/controllers/admin/group.php:176
$lang['Billing Interval'] = 'Billing Interval';

#: application/controllers/admin/group.php:177
$lang['Can Upload Using Flash'] = 'Can Upload Using Flash';

#: application/controllers/admin/group.php:178
$lang['Can Upload Using URLs'] = 'Can Upload Using URLs';

#: application/controllers/admin/group.php:179
$lang['File Expire Time'] = 'File Expire Time';

#: application/controllers/admin/group.php:187
$lang['The name for your Group'] = 'The name for your Group';

#: application/controllers/admin/group.php:188
$lang['The price someone has to pay to register or extend a user account with this group'] = 'The price someone has to pay to register or extend a user account with this group';

#: application/controllers/admin/group.php:189
$lang['The group description'] = 'The group description';

#: application/controllers/admin/group.php:190
$lang['Are users in this group allowed to access the admin panel?'] = 'Are users in this group allowed to access the admin panel?';

#: application/controllers/admin/group.php:191
$lang['Can users in this group use the sitewide file search(only for public files)?'] = 'Can users in this group use the sitewide file search(only for public files)?';

#: application/controllers/admin/group.php:192
$lang['The download speed limit, in KBps'] = 'The download speed limit, in KBps';

#: application/controllers/admin/group.php:193
$lang['The max filesize for uploads, in MB'] = 'The max filesize for uploads, in MB';

#: application/controllers/admin/group.php:194
$lang['The time a user has to wait before they can download a file.'] = 'The time a user has to wait before they can download a file.';

#: application/controllers/admin/group.php:195
$lang['A Pipe("|") seperated list of file types to allow or deny on upload. <br>Leave blank to remove restrictions. The setting below controls this setting.'] = 'A Pipe("|") seperated list of file types to allow or deny on upload. <br>Leave blank to remove restrictions. The setting below controls this setting.';

#: application/controllers/admin/group.php:196
$lang['Allow or deny the above file list.'] = 'Allow or deny the above file list.';

#: application/controllers/admin/group.php:197
$lang['Force a captcha on users in this group before they can download a file'] = 'Force a captcha on users in this group before they can download a file';

#: application/controllers/admin/group.php:198
$lang['If captcha is off, the wait time is 1 or less and this is set to yes, file links will auto download.'] = 'If captcha is off, the wait time is 1 or less and this is set to yes, file links will auto download.';

#: application/controllers/admin/group.php:199
$lang['The number of files a user can upload at once without refreshing the page.'] = 'The number of files a user can upload at once without refreshing the page.';

#: application/controllers/admin/group.php:200
$lang['The total size in megabytes that any user in thes group can store at one time.'] = 'The total size in megabytes that any user in thes group can store at one time.';

#: application/controllers/admin/group.php:201
$lang['The period of time where an account is billed for service'] = 'The period of time where an account is billed for service';

#: application/controllers/admin/group.php:202
$lang['Can the user search through public files?'] = 'Can the user search through public files?';

#: application/controllers/admin/group.php:203
$lang['Can the user upload files using flash?'] = 'Can the user upload files using flash?';

#: application/controllers/admin/group.php:204
$lang['Can the user upload files from other sites(URL Upload)?'] = 'Can the user upload files from other sites(URL Upload)?';

#: application/controllers/admin/group.php:205
$lang['The ammount of time in days that a file uploaded by this group is kept on the server.'] = 'The ammount of time in days that a file uploaded by this group is kept on the server.';
...
$lang['First Download'] = 'First Download';
...
$lang['Manage Servers'] = 'Manage Servers';

#: application/controllers/admin/server.php:75
$lang['New Server Installed, %s'] = 'New Server Installed, %s';

#: application/controllers/admin/server.php:75
$lang['FTP Install this server?'] = 'FTP Install this server?';
...
$lang['Add New Server'] = 'Add New Server';

#: application/controllers/admin/server.php:103
$lang['Server Edited'] = 'Server Edited';
...
$lang['Install Server Software'] = 'Install Server Software';

#: application/controllers/admin/server.php:265
$lang['Server turned On'] = 'Server turned On';

#: application/controllers/admin/server.php:272
$lang['Server turned Off'] = 'Server turned Off';

#: application/controllers/admin/server.php:279
$lang['Server removed'] = 'Server removed';

#: application/controllers/admin/skin.php:52
$lang['Manage Skins'] = 'Manage Skins';

#: application/controllers/admin/skin.php:76
$lang['%s New Skin(s) were installed.'] = '%s New Skin(s) were installed.';

#: application/controllers/admin/skin.php:85
$lang['The Skin "%s" has been Uninstalled.'] = 'The Skin "%s" has been Uninstalled.';
...
$lang['Edit Transaction'] = 'Edit Transaction';

#: application/controllers/admin/transactions.php:118
$lang['Transaction Edited!'] = 'Transaction Edited!';

#: application/controllers/admin/transactions.php:132
$lang['Transaction Deleted!'] = 'Transaction Deleted!';
...
$lang['Select Master Language'] = 'Select Master Language';

#: application/controllers/admin/translator.php:173
$lang['Select Language to Translate'] = 'Select Language to Translate';

#: application/controllers/admin/translator.php:180
$lang['Select File to Translate'] = 'Select File to Translate';

#: application/controllers/admin/translator.php:355
$lang['Mismatch - does not exist in master translation'] = 'Mismatch - does not exist in master translation';

#: application/controllers/admin/translator.php:371
$lang['Invalid syntax - check for unbalanced quotation marks'] = 'Invalid syntax - check for unbalanced quotation marks';

#: application/controllers/admin/translator.php:376
$lang['Entry cannot be blank. Defaulted to master translation.'] = 'Entry cannot be blank. Defaulted to master translation.';

#: application/controllers/admin/translator.php:381
$lang['Invalid PHP syntax'] = 'Invalid PHP syntax';
...
#: application/views/install/step4.php:53
$lang['Password'] = 'Password';

#: application/controllers/admin/user.php:201
#: application/controllers/admin/user.php:250
#: application/controllers/user.php:135
#: application/controllers/user.php:177
#: application/controllers/user.php:357
#: application/controllers/user.php:454
#: application/controllers/user.php:517
$lang['Error:'] = 'Error:';

#: application/controllers/admin/user.php:211
$lang['User Edited!'] = 'User Edited!';
...
$lang['User has been deleted'] = 'User has been deleted';

#: application/controllers/admin/user.php:283
$lang['User has been Deactivated'] = 'User has been Deactivated';

#: application/controllers/admin/user.php:290
$lang['User has been Activated'] = 'User has been Activated';

#: application/controllers/admin/user.php:341
$lang['%d User(s) have been deleted'] = '%d User(s) have been deleted';

#: application/views/default/files/get.php:3
$lang['Download File'] = 'Download File';

#: application/controllers/files.php:155
#: application/controllers/files.php:191
$lang['The Captcha you submited was incorrect.'] = 'The Captcha you submited was incorrect.';

#: application/controllers/files.php:383
#: application/controllers/files.php:414
#: application/controllers/files.php:451
#: application/controllers/user.php:418
$lang['Manage Your Files'] = 'Manage Your Files';

#: application/controllers/files.php:437
$lang['Your query returned 0 results, please try again.'] = 'Your query returned 0 results, please try again.';

#: application/controllers/files.php:598
$lang['%d File(s) have been deleted'] = '%d File(s) have been deleted';

#: application/controllers/files.php:643
$lang['Password Protected File'] = 'Password Protected File';
...
#: application/controllers/folder.php:89
$lang['Create File Folder'] = 'Create File Folder';
...
$lang['Forum/BBCode Image Links'] = 'Forum/BBCode Image Links';

#: application/controllers/image.php:119
$lang['View Image Gallery'] = 'View Image Gallery';
...
$lang['User Package Comparison'] = 'User Package Comparison';

#: application/controllers/user.php:66
#: application/controllers/user.php:137
#: application/controllers/user.php:149
#: application/controllers/user.php:699
$lang['Register'] = 'Register';

#: application/views/default/user/register/begin.php:100
#: application/views/install/step4.php:61
...
$lang['Email Address Confirmation'] = 'Email Address Confirmation';
...
$lang['Payment Processing'] = 'Payment Processing';

#: application/controllers/user.php:255
#: application/controllers/user.php:289
$lang['Account Registration'] = 'Account Registration';

#: application/controllers/user.php:269
#: application/controllers/user.php:301
#: application/controllers/user.php:330
$lang['If you are not automatically redirected to payment website within 5 seconds,<br> click \'Make Payment\' below to begin the payment procedure.'] = 'If you are not automatically redirected to payment website within 5 seconds,<br> click \'Make Payment\' below to begin the payment procedure.';
...
$lang['No User is registered with that username/email address combination.'] = 'No User is registered with that username/email address combination.';
...
$lang['The username you requested has already been taken'] = 'The username you requested has already been taken';

#: application/controllers/user.php:586
$lang['That username does not exist in our records'] = 'That username does not exist in our records';

#: application/controllers/user.php:597
$lang['The email address you supplied is already registered with us'] = 'The email address you supplied is already registered with us';

#: application/controllers/user.php:612
$lang['The email address you supplied is not registered with us.'] = 'The email address you supplied is not registered with us.';

#: application/controllers/user.php:632
$lang['The Old Password you supplied did not match our records'] = 'The Old Password you supplied did not match our records';

#: application/controllers/user.php:657
$lang['Login Failed, Please Try Again'] = 'Login Failed, Please Try Again';

#: application/controllers/user.php:726
#: application/controllers/user.php:760
$lang['User Modification Completed!'] = 'User Modification Completed!';

#: application/controllers/user.php:731
#: application/controllers/user.php:767
$lang['User Modification Failed:'] = 'User Modification Failed:';
...
$lang['View PHPINFO Debug/Settings Output'] = 'View PHPINFO Debug/Settings Output';

#: application/views/default/admin/actions/view.php:8
$lang['View your local PHPINFO, describing all your PHP settings(opens in a new window).'] = 'View your local PHPINFO, describing all your PHP settings(opens in a new window).';

#: application/views/default/admin/actions/view.php:9
$lang['View PHPINFO Page'] = 'View PHPINFO Page';

#: application/views/default/admin/actions/view.php:12
#: application/views/default/admin/actions/view.php:15
$lang['Clear Site/Settings Cache'] = 'Clear Site/Settings Cache';

#: application/views/default/admin/actions/view.php:14
$lang['Clear your local cache files and generate new ones. This is useful if your getting random PHP errors.'] = 'Clear your local cache files and generate new ones. This is useful if your getting random PHP errors.';

#: application/views/default/admin/actions/view.php:18
#: application/views/default/admin/actions/view.php:21
$lang['Run Site Cron'] = 'Run Site Cron';

#: application/views/default/admin/actions/view.php:20
$lang['Run the site cron now, removing all orphaned files and running any extention cron files.'] = 'Run the site cron now, removing all orphaned files and running any extention cron files.';

#: application/views/default/admin/actions/view.php:24
#: application/views/default/admin/actions/view.php:27
$lang['Sync Server Settings'] = 'Sync Server Settings';

#: application/views/default/admin/actions/view.php:26
$lang['Sync out the latest settings to each slave server, config, user groups and plugins.'] = 'Sync out the latest settings to each slave server, config, user groups and plugins.';

#: application/views/default/admin/config/main.php:3
$lang['Config Settings'] = 'Config Settings';

#: application/views/default/admin/config/main.php:6
$lang['General Config'] = 'General Config';
...
$lang['Send Mass EMail'] = 'Send Mass EMail';

#: application/views/default/admin/email.php:17
$lang['Select user group to send email to'] = 'Select user group to send email to';
...
$lang['Installed Plugins'] = 'Installed Plugins';

#: application/views/default/admin/extend/view.php:12
#: application/views/default/admin/extend/view.php:66
...
#: application/views/default/admin/extend/view.php:77
$lang['By: %s'] = 'By: %s';

#: application/views/default/admin/extend/view.php:46
$lang['New Version Available: v%s'] = 'New Version Available: v%s';

#: application/views/default/admin/extend/view.php:62
$lang['Not Installed Plugins'] = 'Not Installed Plugins';

#: application/views/default/admin/extend/view.php:81
$lang['Visit Plugin Home Page'] = 'Visit Plugin Home Page';

#: application/views/default/admin/extend/view.php:82
$lang['Install Plugin'] = 'Install Plugin';
...
$lang['File Download'] = 'File Download';
...
$lang['File Password'] = 'File Password';
...
$lang['File Manager - Search'] = 'File Manager - Search';

#: application/views/default/admin/files/search.php:7
$lang['Search Text (can be file id, part of a file name, or part of a file description)'] = 'Search Text (can be file id, part of a file name, or part of a file description)';

#: application/views/default/admin/files/search_result.php:3
#: application/views/default/admin/folders/search_result.php:3
$lang['File Manager - Search Result'] = 'File Manager - Search Result';
...
$lang['Search Query'] = 'Search Query';
...
$lang['Ban This File'] = 'Ban This File';

#: application/views/default/admin/files/search_result.php:72
#: application/views/default/admin/files/view.php:67
#: application/views/default/admin/folders/search_result.php:72
#: application/views/default/admin/folders/view.php:44
$lang['Are you sure you want to ban this file?'] = 'Are you sure you want to ban this file?';
...
$lang['Are you sure you want to ban these files?'] = 'Are you sure you want to ban these files?';
...
$lang['Are you sure you want to delete these files?'] = 'Are you sure you want to delete these files?';
...
$lang['Edit This File'] = 'Edit This File';

#: application/views/default/admin/files/view.php:66
#: application/views/default/admin/folders/search_result.php:69
#: application/views/default/admin/folders/view.php:41
$lang['Delete This File'] = 'Delete This File';
...
$lang['Folder Manager'] = 'Folder Manager';
...
$lang['Disable Gateway'] = 'Disable Gateway';
...
$lang['"%s" Group - Edit'] = '"%s" Group - Edit';
...
$lang['Groups - Manage'] = 'Groups - Manage';
...
$lang['Make Private'] = 'Make Private';

#: application/views/default/admin/groups/view.php:48
$lang['Make Public'] = 'Make Public';
...
$lang['Important Server Settings'] = 'Important Server Settings';

#: application/views/default/admin/home.php:8
$lang['The largest uploaded file size this server is configured to process is <em>{$}B</em>. <br>This overrides your group settings.'] = 'The largest uploaded file size this server is configured to process is <em>{$}B</em>. <br>This overrides your group settings.';

#: application/views/default/admin/home.php:9
$lang['The maximum size of all allowed POST data is <em>{$}B</em>'] = 'The maximum size of all allowed POST data is <em>{$}B</em>';

#: application/views/default/admin/home.php:10
$lang['The longest amount of time your server can execute PHP files is <em>{$} second(s)</em>'] = 'The longest amount of time your server can execute PHP files is <em>{$} second(s)</em>';

#: application/views/default/admin/home.php:11
$lang['The longest request your server will process is <em>{$} second(s</em>)'] = 'The longest request your server will process is <em>{$} second(s</em>)';

#: application/views/default/admin/home.php:12
$lang['The maximum amount of memory a PHP script can use is <em>{$}B</em>'] = 'The maximum amount of memory a PHP script can use is <em>{$}B</em>';

#: application/views/default/admin/home.php:13
$lang['Enable the use of PHP short opening tags "&lt;?": {$}'] = 'Enable the use of PHP short opening tags "&lt;?": {$}';

#: application/views/default/admin/home.php:16
$lang['Max File Size'] = 'Max File Size';

#: application/views/default/admin/home.php:17
$lang['Max POST-Request Size'] = 'Max POST-Request Size';

#: application/views/default/admin/home.php:18
$lang['Execution Timeout'] = 'Execution Timeout';

#: application/views/default/admin/home.php:19
$lang['Request Input Timeout'] = 'Request Input Timeout';

#: application/views/default/admin/home.php:20
$lang['Memory Limit'] = 'Memory Limit';

#: application/views/default/admin/home.php:21
$lang['Allow PHP Short Tags'] = 'Allow PHP Short Tags';
...
$lang['Some of the above Settings are not ideal, please inspect these to ensure minimal problems.'] = 'Some of the above Settings are not ideal, please inspect these to ensure minimal problems.';

#: application/views/default/admin/home.php:138
$lang['Upgrade Available'] = 'Upgrade Available';

#: application/views/default/admin/home.php:140
$lang['Important Upgrade Available'] = 'Important Upgrade Available';

#: application/views/default/admin/home.php:141
$lang['Important Upgrade Available %s'] = 'Important Upgrade Available %s';

#: application/views/default/admin/home.php:147
$lang['XtraUpload v3 Stats'] = 'XtraUpload v3 Stats';

#: application/views/default/admin/home.php:151
$lang['Number of Uploads'] = 'Number of Uploads';

#: application/views/default/admin/home.php:155
$lang['Total Disk Space Used'] = 'Total Disk Space Used';

#: application/views/default/admin/home.php:161
$lang['Number of Registered Users'] = 'Number of Registered Users';

#: application/views/default/admin/home.php:165
$lang['Total Bandwidth Used'] = 'Total Bandwidth Used';

#: application/views/default/admin/home.php:171
$lang['Number of Admins'] = 'Number of Admins';

#: application/views/default/admin/home.php:175
$lang['Number of Active Servers'] = 'Number of Active Servers';

#: application/views/default/admin/home.php:180
$lang['Server Stats'] = 'Server Stats';
...
$lang['Total Disk Space'] = 'Total Disk Space';

#: application/views/default/admin/home.php:209
$lang['Files on Server'] = 'Files on Server';

#: application/views/default/admin/home.php:217
$lang['Useful Information'] = 'Useful Information';

#: application/views/default/admin/home.php:219
$lang['You are using the %s with %s.'] = 'You are using the %s with %s.';

#: application/views/default/admin/home.php:219
$lang['%s skin'] = '%s skin';

#: application/views/default/admin/home.php:219
$lang['%s plugins'] = '%s plugins';

#: application/views/default/admin/home.php:220
$lang['This is XtraUpload version'] = 'This is XtraUpload version';

#: application/views/default/admin/home.php:222
$lang['Last 5 Admin Logins'] = 'Last 5 Admin Logins';
...
$lang['Admin Shortcuts'] = 'Admin Shortcuts';
...
$lang['Admin Shortcut Manager'] = 'Admin Shortcut Manager';
...
$lang['Link Locaton'] = 'Link Locaton';

#: application/views/default/admin/menu_shortcuts/view.php:35
$lang['Turn Off Shortcut'] = 'Turn Off Shortcut';
...
$lang['Turn On Shortcut'] = 'Turn On Shortcut';
...
$lang['Edit This Shortcut'] = 'Edit This Shortcut';

#: application/views/default/admin/menu_shortcuts/view.php:52
$lang['Delete This Shortcut'] = 'Delete This Shortcut';

#: application/views/default/admin/menu_shortcuts/view.php:52
$lang['Are you sure you want to delete this shortcut?'] = 'Are you sure you want to delete this shortcut?';
...
$lang['Important Information'] = 'Important Information';

#: application/views/default/admin/servers/install-step1.php:18
#: application/views/default/admin/servers/install.php:34
$lang['This will FTP all php files required for a clean server install overwriting old files.'] = 'This will FTP all php files required for a clean server install overwriting old files.';

#: application/views/default/admin/servers/install-step1.php:19
#: application/views/default/admin/servers/install.php:35
$lang['THIS WILL ERASE ALL CHANGES YOU MIGHT HAVE MADE ON THIS SERVER!'] = 'THIS WILL ERASE ALL CHANGES YOU MIGHT HAVE MADE ON THIS SERVER!';

#: application/views/default/admin/servers/install-step1.php:30
$lang['Confirm Software Install'] = 'Confirm Software Install';

#: application/views/default/admin/servers/install-step1.php:31
$lang['We have confirmed a working FTP connection to the server you specified. Please click the button below to confirm that you want to install server software on this server.'] = 'We have confirmed a working FTP connection to the server you specified. Please click the button below to confirm that you want to install server software on this server.';

#: application/views/default/admin/servers/install-step2.php:11
$lang['Install Complete!'] = 'Install Complete!';

#: application/views/default/admin/servers/install-step2.php:12
$lang['The server file have been installed on the remote server. If you notice any problems with the install please double check the installer using the server install guid in the docs. Please use the above button to go back to the server manager.'] = 'The server file have been installed on the remote server. If you notice any problems with the install please double check the installer using the server install guid in the docs. Please use the above button to go back to the server manager.';

#: application/views/default/admin/servers/install.php:16
$lang['Error(s) Occured'] = 'Error(s) Occured';

#: application/views/default/admin/servers/install.php:40
$lang['Server FTP Details'] = 'Server FTP Details';

#: application/views/default/admin/servers/install.php:42
$lang['FTP URL'] = 'FTP URL';
...
$lang['FTP Port'] = 'FTP Port';

#: application/views/default/admin/servers/install.php:50
$lang['FTP Path to install location'] = 'FTP Path to install location';

#: application/views/default/admin/servers/install.php:52
$lang['Validate FTP Settings'] = 'Validate FTP Settings';

#: application/views/default/admin/servers/install_error.php:18
$lang['You do not have the server package downloaded!'] = 'You do not have the server package downloaded!';

#: application/views/default/admin/servers/install_error.php:20
$lang['Please download the latest server package from the %s.'] = 'Please download the latest server package from the %s.';

#: application/views/default/admin/servers/install_error.php:20
$lang['XtraFile.com Download Page'] = 'XtraFile.com Download Page';

#: application/views/default/admin/servers/install_error.php:21
$lang['Once you have downloaded the package follow these steps:'] = 'Once you have downloaded the package follow these steps:';

#: application/views/default/admin/servers/install_error.php:23
$lang['Extract the package'] = 'Extract the package';

#: application/views/default/admin/servers/install_error.php:24
$lang['Login to this server via FTP'] = 'Login to this server via FTP';

#: application/views/default/admin/servers/install_error.php:25
$lang['Create a new folder in the xu2 root folder, name it %sserver_package%s'] = 'Create a new folder in the xu2 root folder, name it %sserver_package%s';

#: application/views/default/admin/servers/install_error.php:26
$lang['Upload the extracted files to that folder'] = 'Upload the extracted files to that folder';

#: application/views/default/admin/servers/install_error.php:27
$lang['Refresh this page'] = 'Refresh this page';

#: application/views/default/admin/servers/view.php:3
$lang['Server Manager'] = 'Server Manager';
...
$lang['Delete This Skin'] = 'Delete This Skin';

#: application/views/default/admin/stats.php:6
$lang['Information'] = 'Information';

#: application/views/default/admin/stats.php:8
$lang['Here you can view a graphical representation of many site stats including weekly upload count, new users, total used space by server, etc. Please select a chart to view the corresponding data.'] = 'Here you can view a graphical representation of many site stats including weekly upload count, new users, total used space by server, etc. Please select a chart to view the corresponding data.';

#: application/views/default/admin/stats.php:12
$lang['Select a Chart'] = 'Select a Chart';
...
$lang['All Uploads'] = 'All Uploads';

#: application/views/default/admin/stats.php:16
#: application/views/default/admin/stats.php:21
$lang['Files vs Images'] = 'Files vs Images';

#: application/views/default/admin/stats.php:17
#: application/views/default/admin/stats.php:22
$lang['Local vs Remote'] = 'Local vs Remote';

#: application/views/default/admin/stats.php:18
$lang['By Server'] = 'By Server';

#: application/views/default/admin/stats.php:20
#: application/views/default/admin/stats.php:21
#: application/views/default/admin/stats.php:22
$lang['New Uploads'] = 'New Uploads';
...
$lang['Please select a Chart'] = 'Please select a Chart';

#: application/views/default/admin/stats.php:44
$lang['Your Requested Chart'] = 'Your Requested Chart';

#: application/views/default/admin/transactions/edit.php:7
$lang['Transaction Info'] = 'Transaction Info';

#: application/views/default/admin/transactions/view.php:3
$lang['Transaction Manager'] = 'Transaction Manager';
...
$lang['Approve Transaction'] = 'Approve Transaction';
...
$lang['User - Edit'] = 'User - Edit';

#: application/views/default/admin/users/search.php:3
$lang['User Manager - Search'] = 'User Manager - Search';

#: application/views/default/admin/users/search.php:7
$lang['Search Text(can be username, email address, or ip address)'] = 'Search Text(can be username, email address, or ip address)';

#: application/views/default/admin/users/search_result.php:3
$lang['Manage Users - Search'] = 'Manage Users - Search';
...
$lang['Are you sure you want to delete these users?'] = 'Are you sure you want to delete these users?';

#: application/views/default/admin/users/view.php:3
$lang['Users - Manage'] = 'Users - Manage';
...
$lang['All Uploads >> Files vs Images'] = 'All Uploads >> Files vs Images';
...
$lang['Uploads >> Local vs Remote'] = 'Uploads >> Local vs Remote';
...
$lang['File-Server Uploads Distrubition'] = 'File-Server Uploads Distrubition';

#: application/views/default/api/charts/all_server_used_space.php:6
$lang['Servers >> Used Space'] = 'Servers >> Used Space';

#: application/views/default/api/charts/downloads_monthly.php:8
#: application/views/default/api/charts/downloads_weekly.php:5
$lang['Past 7 Days Downloads'] = '過去7日間のダウンロード数';
...
#: application/views/default/api/charts/images_vs_regular_weekly.php:5
$lang['New Uploads >> Files vs Images >> Weekly'] = 'New Uploads >> Files vs Images >> Weekly';

#: application/views/default/api/charts/remote_vs_host_uploads_weekly.php:5
$lang['New Uploads >> Local vs Remote >> Weekly'] = 'New Uploads >> Local vs Remote >> Weekly';

#: application/views/default/api/charts/total_new_users_weekly.php:5
$lang['New Users >> Weekly'] = 'New Users >> Weekly';

#: application/views/default/api/charts/uploads_weekly.php:5
$lang['Past 7 Days Uploads'] = 'Past 7 Days Uploads';

#: application/views/default/files/404.php:3
$lang['File Link Error'] = 'File Link Error';

#: application/views/default/files/404.php:5
$lang['Your file could not be found. Please check the download link.'] = 'Your file could not be found. Please check the download link.';

#: application/views/default/files/get.php:10
$lang['File Details'] = 'File Details';
...
$lang['MD5 Checksum:'] = 'MD5 Checksum:';

#: application/views/default/files/get.php:53
$lang['Date Uploaded:'] = 'Date Uploaded:';
...
$lang['Your account is limited by storage space:'] = 'Your account is limited by storage space:';

#: application/views/default/files/manage.php:18
#: application/views/default/home.php:62
$lang['You have %d of %d MB remaining.'] = 'You have %d of %d MB remaining.';
...
$lang['Show/Hide Links'] = 'Show/Hide Links';

#: application/views/default/files/manage.php:59
$lang['Are you SURE you want to do this?'] = 'Are you SURE you want to do this?';
...
#: application/views/default/user/files.php:51
$lang['Download Link'] = 'Download Link';
...
$lang['Feature This File?'] = 'Feature This File?';
...
$lang['Download File - Enter Password'] = 'Download File - Enter Password';

#: application/views/default/files/pass_protected.php:6
$lang['The Password you submited was incorrect.'] = 'The Password you submited was incorrect.';

#: application/views/default/files/pass_protected.php:9
$lang['Enter File Password'] = 'Enter File Password';

#: application/views/default/files/pass_protected.php:11
$lang['This file has been password protected by the uploader. You must provide the correct password to download this file.'] = 'This file has been password protected by the uploader. You must provide the correct password to download this file.';
...
$lang['You are currently not allowed to search files. Please %s to gain access.'] = 'You are currently not allowed to search files. Please %s to gain access.';
...
$lang['Your query \'%s\' returned %d result(s)'] = 'Your query \'%s\' returned %d result(s)';
...
$lang['File Folder - Create'] = 'File Folder - Create';

#: application/views/default/folder/create.php:7
$lang['You do not have any uploaded files.'] = 'You do not have any uploaded files.';

#: application/views/default/folder/create.php:9
$lang['Please upload some first.'] = 'Please upload some first.';
...
$lang['File Folder - Created'] = 'File Folder - Created';
...
$lang['Upload Restrictions'] = 'Upload Restrictions';

#: application/views/default/home.php:46
$lang['You can upload %s files at %s MB each.'] = 'You can upload %s files at %s MB each.';

#: application/views/default/home.php:53
$lang['You can upload these file types: %s'] = 'You can upload these file types: %s';

#: application/views/default/home.php:53
$lang['You cannot upload these file types: %s'] = 'You cannot upload these file types: %s';

#: application/views/default/home.php:72
$lang['Error'] = 'Error';

#: application/views/default/home.php:73
$lang['Get Flash!'] = 'Get Flash!';

#: application/views/default/home.php:75
$lang['Get Adobe Flash player'] = 'Get Adobe Flash player';

#: application/views/default/home.php:79
$lang['Upload a File'] = 'Upload a File';

#: application/views/default/home.php:81
$lang['This is a backup upload form for our users who do not have Flash installed, to access our advanced uploading features please install the Flash Plugin and enable Javascript.'] = 'This is a backup upload form for our users who do not have Flash installed, to access our advanced uploading features please install the Flash Plugin and enable Javascript.';
...
$lang['Queued File List'] = 'Queued File List';

#: application/views/default/home.php:109
$lang['You have selected the following files for upload (%s) files.'] = 'You have selected the following files for upload (%s) files.';

#: application/views/default/home.php:111
$lang['You have selected previously selected files for upload.'] = 'You have selected previously selected files for upload.';

#: application/views/default/home.php:112
#: application/views/default/home.php:116
#: application/views/default/home.php:120
$lang['These files have been removed.'] = 'These files have been removed.';

#: application/views/default/home.php:115
$lang['One or more of the files you selected were too large.'] = 'One or more of the files you selected were too large.';

#: application/views/default/home.php:119
$lang['One or more of the files you selected are not allowed.'] = 'One or more of the files you selected are not allowed.';

#: application/views/default/home.php:123
$lang['You have selected to many files to upload at once. You are limited to %s files.'] = 'You have selected to many files to upload at once. You are limited to %s files.';

#: application/views/default/home.php:124
$lang['Please select fewer files and try again.'] = 'Please select fewer files and try again.';

#: application/views/default/home.php:127
$lang['An unknown error has occured.'] = 'An unknown error has occured.';

#: application/views/default/home.php:128
$lang['Please contact us about this error'] = 'Please contact us about this error';
...
$lang['Edit File Details'] = 'Edit File Details';
...
$lang['BBCode Links'] = 'BBCode Links';

#: application/views/default/image/links.php:13
$lang['Show image to friends:'] = 'Show image to friends:';

#: application/views/default/image/links.php:15
$lang['Hotlink for forums:'] = 'Hotlink for forums:';

#: application/views/default/image/links.php:17
$lang['Hotlink for forums (alt):'] = 'Hotlink for forums (alt):';

#: application/views/default/image/links.php:19
$lang['Thumbnail link for forums:'] = 'Thumbnail link for forums:';

#: application/views/default/image/links.php:21
$lang['Thumbnail link for forums (alt):'] = 'Thumbnail link for forums (alt):';

#: application/views/default/image/links.php:23
$lang['Hotlink for websites with thumbnail(HTML):'] = 'Hotlink for websites with thumbnail(HTML):';

#: application/views/default/image/links.php:25
$lang['Hotlink for websites, full image(HTML):'] = 'Hotlink for websites, full image(HTML):';

#: application/views/default/image/links.php:27
$lang['Direct link to image:'] = 'Direct link to image:';

#: application/views/default/legal/privacy.php:5
$lang['Your privacy is very important to us. Accordingly, we have developed this Policy in order for you to understand how we collect, use, communicate and disclose and make use of personal information. The following outlines our privacy policy.'] = 'Your privacy is very important to us. Accordingly, we have developed this Policy in order for you to understand how we collect, use, communicate and disclose and make use of personal information. The following outlines our privacy policy.';

#: application/views/default/legal/privacy.php:7
$lang['Before or at the time of collecting personal information, we will identify the purposes for which information is being collected.'] = 'Before or at the time of collecting personal information, we will identify the purposes for which information is being collected.';

#: application/views/default/legal/privacy.php:8
$lang['We will collect and use of personal information solely with the objective of fulfilling those purposes specified by us and for other compatible purposes, unless we obtain the consent of the individual concerned or as required by law.'] = 'We will collect and use of personal information solely with the objective of fulfilling those purposes specified by us and for other compatible purposes, unless we obtain the consent of the individual concerned or as required by law.';

#: application/views/default/legal/privacy.php:9
$lang['We will only retain personal information as long as necessary for the fulfillment of those purposes.'] = 'We will only retain personal information as long as necessary for the fulfillment of those purposes.';

#: application/views/default/legal/privacy.php:10
$lang['We will collect personal information by lawful and fair means and, where appropriate, with the knowledge or consent of the individual concerned.'] = 'We will collect personal information by lawful and fair means and, where appropriate, with the knowledge or consent of the individual concerned.';
...
$lang['We will protect personal information by reasonable security safeguards against loss or theft, as well as unauthorized access, disclosure, copying, use or modification.'] = 'We will protect personal information by reasonable security safeguards against loss or theft, as well as unauthorized access, disclosure, copying, use or modification.';

#: application/views/default/legal/privacy.php:13
$lang['We will make readily available to customers information about our policies and practices relating to the management of personal information.'] = 'We will make readily available to customers information about our policies and practices relating to the management of personal information.';

#: application/views/default/legal/privacy.php:15
$lang['We are committed to conducting our business in accordance with these principles in order to ensure that the confidentiality of personal information is protected and maintained.'] = 'We are committed to conducting our business in accordance with these principles in order to ensure that the confidentiality of personal information is protected and maintained.';

#: application/views/default/legal/tos.php:3
$lang['Web Site Terms and Conditions of Use'] = 'Web Site Terms and Conditions of Use';

#: application/views/default/legal/tos.php:5
$lang['1. Terms'] = '1. Terms';

#: application/views/default/legal/tos.php:6
$lang['By accessing this web site, you are agreeing to be bound by these web site Terms and Conditions of Use, all applicable laws and regulations, and agree that you are responsible for compliance with any applicable local laws. If you do not agree with any of these terms, you are prohibited from using or accessing this site. The materials contained in this web site are protected by applicable copyright and trade mark law.'] = 'By accessing this web site, you are agreeing to be bound by these web site Terms and Conditions of Use, all applicable laws and regulations, and agree that you are responsible for compliance with any applicable local laws. If you do not agree with any of these terms, you are prohibited from using or accessing this site. The materials contained in this web site are protected by applicable copyright and trade mark law.';

#: application/views/default/legal/tos.php:7
$lang['2. Use License'] = '2. Use License';

#: application/views/default/legal/tos.php:10
$lang['Permission is granted to temporarily download one copy of the materials (information or software) on %s \'s web site for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:'] = 'Permission is granted to temporarily download one copy of the materials (information or software) on %s \'s web site for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:';

#: application/views/default/legal/tos.php:12
$lang['modify or copy the materials;'] = 'modify or copy the materials;';

#: application/views/default/legal/tos.php:13
$lang['use the materials for any commercial purpose, or for any public display (commercial or non-commercial);'] = 'use the materials for any commercial purpose, or for any public display (commercial or non-commercial);';

#: application/views/default/legal/tos.php:14
$lang['attempt to decompile or reverse engineer any software contained on %s \'s web site;'] = 'attempt to decompile or reverse engineer any software contained on %s \'s web site;';

#: application/views/default/legal/tos.php:15
$lang['remove any copyright or other proprietary notations from the materials; or'] = 'remove any copyright or other proprietary notations from the materials; or';

#: application/views/default/legal/tos.php:16
$lang['transfer the materials to another person or "mirror" the materials on any other server.'] = 'transfer the materials to another person or "mirror" the materials on any other server.';

#: application/views/default/legal/tos.php:19
$lang['This license shall automatically terminate if you violate any of these restrictions and may be terminated by %s at any time. Upon terminating your viewing of these materials or upon the termination of this license, you must destroy any downloaded materials in your possession whether in electronic or printed format.'] = 'This license shall automatically terminate if you violate any of these restrictions and may be terminated by %s at any time. Upon terminating your viewing of these materials or upon the termination of this license, you must destroy any downloaded materials in your possession whether in electronic or printed format.';

#: application/views/default/legal/tos.php:21
$lang['3. Disclaimer'] = '3. Disclaimer';

#: application/views/default/legal/tos.php:23
$lang['The materials on %s \'s web site are provided "as is". %s makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties, including without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights. Further, %s does not warrant or make any representations concerning the accuracy, likely results, or reliability of the use of the materials on its Internet web site or otherwise relating to such materials or on any sites linked to this site.'] = 'The materials on %s \'s web site are provided "as is". %s makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties, including without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights. Further, %s does not warrant or make any representations concerning the accuracy, likely results, or reliability of the use of the materials on its Internet web site or otherwise relating to such materials or on any sites linked to this site.';

#: application/views/default/legal/tos.php:25
$lang['4. Limitations'] = '4. Limitations';

#: application/views/default/legal/tos.php:26
$lang['In no event shall %s or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption,) arising out of the use or inability to use the materials on %s \'s Internet site, even if %s or a %s authorized representative has been notified orally or in writing of the possibility of such damage. Because some jurisdictions do not allow limitations on implied warranties, or limitations of liability for consequential or incidental damages, these limitations may not apply to you.'] = 'In no event shall %s or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption,) arising out of the use or inability to use the materials on %s \'s Internet site, even if %s or a %s authorized representative has been notified orally or in writing of the possibility of such damage. Because some jurisdictions do not allow limitations on implied warranties, or limitations of liability for consequential or incidental damages, these limitations may not apply to you.';

#: application/views/default/legal/tos.php:27
$lang['5. Revisions and Errata'] = '5. Revisions and Errata';

#: application/views/default/legal/tos.php:28
$lang['The materials appearing on %s \'s web site could include technical, typographical, or photographic errors. %s does not warrant that any of the materials on its web site are accurate, complete, or current. %s may make changes to the materials contained on its web site at any time without notice. %s does not, however, make any commitment to update the materials.'] = 'The materials appearing on %s \'s web site could include technical, typographical, or photographic errors. %s does not warrant that any of the materials on its web site are accurate, complete, or current. %s may make changes to the materials contained on its web site at any time without notice. %s does not, however, make any commitment to update the materials.';

#: application/views/default/legal/tos.php:29
$lang['6. Links'] = '6. Links';

#: application/views/default/legal/tos.php:30
$lang['%s has not reviewed all of the sites linked to its Internet web site and is not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement by %s of the site. Use of any such linked web site is at the user\'s own risk.'] = '%s has not reviewed all of the sites linked to its Internet web site and is not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement by %s of the site. Use of any such linked web site is at the user\'s own risk.';

#: application/views/default/legal/tos.php:31
$lang['7. Site Terms of Use Modifications'] = '7. Site Terms of Use Modifications';

#: application/views/default/legal/tos.php:32
$lang['%s may revise these terms of use for its web site at any time without notice. By using this web site you are agreeing to be bound by the then current version of these Terms and Conditions of Use.'] = '%s may revise these terms of use for its web site at any time without notice. By using this web site you are agreeing to be bound by the then current version of these Terms and Conditions of Use.';

#: application/views/default/legal/tos.php:33
$lang['8. Governing Law'] = '8. Governing Law';
...
$lang['Your file links are below, make sure to save this URL if you ever need to get these links again.'] = 'Your file links are below, make sure to save this URL if you ever need to get these links again.';
...
$lang['Error: Upload Failed!!'] = 'Error: Upload Failed!!';

#: application/views/default/upload/failed.php:6
#: application/views/default/upload/links.php:6
$lang['Reason: %s'] = 'Reason: %s';

#: application/views/default/upload/url.php:3
$lang['URL Upload(beta)'] = 'URL Upload(beta)';

#: application/views/default/upload/url.php:10
$lang['You are currently not allowed to use URL Upload. Please %s to gain access.'] = 'You are currently not allowed to use URL Upload. Please %s to gain access.';

#: application/views/default/upload/url.php:18
$lang['Upload files from other servers on the internet.'] = 'Upload files from other servers on the internet.';

#: application/views/default/upload/url.php:19
$lang['%sThis is still a beta service%s and there might still be bugs in it. Please email us and let us know if you find any or encounter any "Upload Failed!" errors.'] = '%sThis is still a beta service%s and there might still be bugs in it. Please email us and let us know if you find any or encounter any "Upload Failed!" errors.';

#: application/views/default/upload/url.php:25
$lang['Remote Upload URLs, one per line'] = 'Remote Upload URLs, one per line';
...
$lang['Begin Upload!'] = 'Begin Upload!';
...
$lang['Listed below are all of our available signup packages. You can pick which one you want on the user registration page.'] = 'Listed below are all of our available signup packages. You can pick which one you want on the user registration page.';

#: application/views/default/user/compare.php:11
$lang['Download Speed Limit'] = 'Download Speed Limit';

#: application/views/default/user/compare.php:12
$lang['Upload File Size'] = 'Upload File Size';

#: application/views/default/user/compare.php:14
$lang['Captcha on Download?'] = 'Captcha on Download?';

#: application/views/default/user/compare.php:16
$lang['Mass File Upload Limit'] = 'Mass File Upload Limit';

#: application/views/default/user/compare.php:17
$lang['Account Storage Limits'] = 'Account Storage Limits';

#: application/views/default/user/compare.php:18
$lang['Billing Schedule'] = 'Billing Schedule';

#: application/views/default/user/compare.php:19
$lang['Price'] = 'Price';

#: application/views/default/user/compare.php:20
$lang['Active File Storage Time'] = 'Active File Storage Time';

#: application/views/default/user/compare.php:21
$lang['Can Search Files'] = 'Can Search Files';

#: application/views/default/user/compare.php:22
$lang['Can Upload Local Files'] = 'Can Upload Local Files';

#: application/views/default/user/compare.php:23
$lang['Can URL Upload'] = 'Can URL Upload';
...
$lang['Every 2 Years'] = 'Every 2 Years';
...
$lang['User Files: %s'] = 'User Files: %s';

#: application/views/default/user/files.php:9
$lang['This user does not allow public viewing of their files.'] = 'This user does not allow public viewing of their files.';
...
$lang['You have been logged out. Please wait while we forward you to the home page.'] = 'You have been logged out. Please wait while we forward you to the home page.';

#: application/views/default/user/manage.php:9
$lang['Manage User'] = 'Manage User';
...
$lang['User Profile: %s'] = 'User Profile: %s';

#: application/views/default/user/profile/view.php:13
$lang['This is your user profile!'] = 'This is your user profile!';

#: application/views/default/user/profile/view.php:14
$lang['You can update these values %s!'] = 'You can update these values %s!';
...
$lang['Uploaded Files: %s'] = 'Uploaded Files: %s';
...
$lang['Register New User'] = 'Register New User';

#: application/views/default/user/register/begin.php:12
$lang['Click here for a comparision'] = 'Click here for a comparision';
...
$lang['Security Test - Type the letters you see below:'] = 'Security Test - Type the letters you see below:';

#: application/views/default/user/register/begin.php:105
$lang['Submit Registration'] = 'Submit Registration';
...
$lang['Registrations Closed'] = 'Registrations Closed';

#: application/views/default/user/register/closed.php:10
$lang['We are sorry but we are not currently allowing new registrations.'] = 'We are sorry but we are not currently allowing new registrations.';

#: application/views/default/user/register/closed.php:11
$lang['Please check back later, as we may open up more spots in the future.'] = 'Please check back later, as we may open up more spots in the future.';

#: application/views/default/user/register/complete.php:6
$lang['Your account has been created and your info has been emailed to you.'] = 'Your account has been created and your info has been emailed to you.';

#: application/views/default/user/register/complete.php:7
$lang['You have been logged in, please return to the home page.'] = 'You have been logged in, please return to the home page.';

#: application/views/default/user/register/pay_cancel.php:5
$lang['You have canceled the payment prematurely. Please visit the pay link included in the email you recived to complete payment and activate your account.'] = 'You have canceled the payment prematurely. Please visit the pay link included in the email you recived to complete payment and activate your account.';

#: application/views/default/user/register/pay_complete.php:3
#: application/views/default/user/register/pay_complete.php:5
$lang['Payment Complete'] = 'Payment Complete';
...
$lang['Welcome to XtraUpload Installer'] = 'Welcome to XtraUpload Installer';

#: application/views/install/setup.php:4
$lang['Details about the system requirements are below.'] = 'Details about the system requirements are below.';

#: application/views/install/setup.php:12
$lang['Thank you for Downloading XtraUpload.'] = 'Thank you for Downloading XtraUpload.';

#: application/views/install/setup.php:13
$lang['We hope you find the installation of this script a breeze as it is all automated making it simple to use for someone with very limited knowledge of php, Installing etc.'] = 'We hope you find the installation of this script a breeze as it is all automated making it simple to use for someone with very limited knowledge of php, Installing etc.';

#: application/views/install/setup.php:14
$lang['XtraUpload works best on PHP 5.3.0 or better, MySQL 5.1 or better, and an unused database.'] = 'XtraUpload works best on PHP 5.3.0 or better, MySQL 5.1 or better, and an unused database.';

#: application/views/install/setup.php:15
$lang['Please gather this information ready:'] = 'Please gather this information ready:';

#: application/views/install/setup.php:18
$lang['SQL database name (Create on via cpanel or some other software you have)'] = 'SQL database name (Create on via cpanel or some other software you have)';

#: application/views/install/setup.php:19
$lang['Your SQL username'] = 'Your SQL username';

#: application/views/install/setup.php:20
$lang['Your SQL host address (Usually localhost but if all else fails try the ip address)'] = 'Your SQL host address (Usually localhost but if all else fails try the ip address)';

#: application/views/install/setup.php:22
$lang['Click continue to carry on with this installation. You will be given a progress bar to show you how much is left to install.'] = 'Click continue to carry on with this installation. You will be given a progress bar to show you how much is left to install.';

#: application/views/install/setup.php:23
$lang['Do not click back once you have reached step 5. This Will cause database errors!'] = 'Do not click back once you have reached step 5. This Will cause database errors!';
...
$lang['License Agreement'] = 'License Agreement';

#: application/views/install/step1.php:5
#: application/views/install/step1.php:6
...
#: application/views/install/step2.php:6
#: application/views/install/step2.php:7
...
#: application/views/install/step3.php:6
#: application/views/install/step3.php:7
...
#: application/views/install/step4.php:6
#: application/views/install/step4.php:7
...
#: application/views/install/step5.php:6
#: application/views/install/step5.php:7
...
$lang['XtraUpload License Agreement Below'] = 'XtraUpload License Agreement Below';

#: application/views/install/step1.php:34
$lang['You must agree to the XtraUpload License before installing XtraUpload.'] = 'You must agree to the XtraUpload License before installing XtraUpload.';

#: application/views/install/step1.php:35
$lang['By Installing XtraUpload, regardless if you read the License, you are bound by it.'] = 'By Installing XtraUpload, regardless if you read the License, you are bound by it.';

#: application/views/install/step1.php:38
$lang['An online copy of this license can be found at %s'] = 'An online copy of this license can be found at %s';

#: application/views/install/step1.php:44
$lang['By clicking the "Continue" button below and/or installing/upgrading/using XtraUpload you hearby agree to and are bound by the above license aggrement, including Section 10: ammendments to the Apache License v2.0.'] = 'By clicking the "Continue" button below and/or installing/upgrading/using XtraUpload you hearby agree to and are bound by the above license aggrement, including Section 10: ammendments to the Apache License v2.0.';

#: application/views/install/step2.php:1
$lang['Filesystem And Version Check'] = 'Filesystem And Version Check';

#: application/views/install/step2.php:26
$lang['Server Test Results'] = 'Server Test Results';

#: application/views/install/step2.php:28
$lang['This section outputs the results of a series of tests to ensure everything is configured correctly before installing.'] = 'This section outputs the results of a series of tests to ensure everything is configured correctly before installing.';

#: application/views/install/step2.php:34
$lang['Permission Checks'] = 'Permission Checks';

#: application/views/install/step2.php:41
$lang['File: %s'] = 'File: %s';

#: application/views/install/step2.php:42
$lang['Permissions Required: %s'] = 'Permissions Required: %s';

#: application/views/install/step2.php:52
$lang['Version Checks'] = 'Version Checks';
...
$lang['SimpleXML Support Check'] = 'SimpleXML Support Check';

#: application/views/install/step2.php:96
$lang['FTP Support Check'] = 'FTP Support Check';

#: application/views/install/step2.php:125
$lang['There were errors during testing.'] = 'There were errors during testing.';

#: application/views/install/step2.php:126
$lang['Please fix these errors before continuing.'] = 'Please fix these errors before continuing.';

#: application/views/install/step2.php:127
$lang['If you chose to continue you do so at your own risk.'] = 'If you chose to continue you do so at your own risk.';

#: application/views/install/step3.php:1
#: application/views/install/step4.php:1
$lang['Database and Config Details'] = 'Database and Config Details';

#: application/views/install/step3.php:33
$lang['Website Address'] = 'Website Address';

#: application/views/install/step3.php:34
$lang['Enter your website address here.'] = 'Enter your website address here.';

#: application/views/install/step3.php:38
$lang['Make sure this is correct:'] = 'Make sure this is correct:';

#: application/views/install/step3.php:40
$lang['Please make sure it starts with %s This is the address of all your files EG: http://www.yoursite.com/upload'] = 'Please make sure it starts with %s This is the address of all your files EG: http://www.yoursite.com/upload';

#: application/views/install/step3.php:41
$lang['Trailing slash is required!'] = 'Trailing slash is required!';

#: application/views/install/step3.php:53
$lang['Website Settings'] = 'Website Settings';

#: application/views/install/step3.php:54
$lang['This allows you to set custom cookie prefixes and a custom encryption key. Leave blank to autogenerate these values.'] = 'This allows you to set custom cookie prefixes and a custom encryption key. Leave blank to autogenerate these values.';

#: application/views/install/step3.php:58
$lang['Cookie Prefix'] = 'Cookie Prefix';

#: application/views/install/step3.php:60
$lang['This prevents session collisions with other XU installs around the internet'] = 'This prevents session collisions with other XU installs around the internet';

#: application/views/install/step3.php:68
$lang['Encryption Key'] = 'Encryption Key';

#: application/views/install/step3.php:70
$lang['This is the key that will be used to encrypt sensitive data in XU'] = 'This is the key that will be used to encrypt sensitive data in XU';

#: application/views/install/step3.php:81
$lang['SQL Data'] = 'SQL Data';

#: application/views/install/step3.php:82
$lang['Please enter the correct MySQL info below for the tables to install correctly.'] = 'Please enter the correct MySQL info below for the tables to install correctly.';

#: application/views/install/step3.php:86
$lang['SQL Host'] = 'SQL Host';

#: application/views/install/step3.php:88
$lang['Localhost is default, but in some cases it can be your Server IP Address'] = 'Localhost is default, but in some cases it can be your Server IP Address';

#: application/views/install/step3.php:98
$lang['SQL User'] = 'SQL User';

#: application/views/install/step3.php:107
$lang['SQL Database Name'] = 'SQL Database Name';

#: application/views/install/step3.php:115
$lang['SQL Password'] = 'SQL Password';

#: application/views/install/step3.php:123
$lang['Database Prefix'] = 'Database Prefix';
...
$lang['SQL Engine'] = 'SQL Engine';

#: application/views/install/step3.php:134
$lang['You can choose from 7 different SQL database engines. MySQL is the most popular.'] = 'You can choose from 7 different SQL database engines. MySQL is the most popular.';

#: application/views/install/step4.php:40
$lang['Admin Details'] = 'Admin Details';

#: application/views/install/step4.php:41
$lang['This section requires information to create your administration account. Please enter the data carefully!'] = 'This section requires information to create your administration account. Please enter the data carefully!';
...
$lang['Success! XtraUpload Has Installed Succefully'] = 'Success! XtraUpload Has Installed Succefully';

#: application/views/install/step5.php:40
$lang['Details About The Install Are Below'] = 'Details About The Install Are Below';

#: application/views/install/step5.php:50
$lang['XtraUpload was installed successfully!'] = 'XtraUpload was installed successfully!';

#: application/libraries/functions.php:161
$lang['Not Valid Version Number!'] = 'Not Valid Version Number!';

#: application/libraries/paypal_lib.php:85
$lang['Pay Now!'] = 'Pay Now!';

#: application/libraries/paypal_lib.php:117
$lang['Click here if you\'re not automatically redirected...'] = 'Click here if you\'re not automatically redirected...';
...
/* Location: ./application/language/japanese/global_lang.php */
