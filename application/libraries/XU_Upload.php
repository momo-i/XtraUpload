...
class XU_Upload extends CI_Upload {
	...
	// Is $_FILES[$field] set? If not, no reason to continue.
		...
		$this->file_type = $this->_get_fileinfo($_FILES[$field]['tmp_name']);
	...
	{
		log_message('debug', 'Start '.__FUNCTION__);
		...
		log_message('debug', 'extension: '.$ext);

		if ( ! in_array($ext, $this->allowed_types))
		{
			log_message('debug', "No allowed types. ext: {$ext}");
