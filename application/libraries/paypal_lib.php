...
class Paypal_Lib {
	...
	public function paypal_auto_form() 
	{
		...
		$this->button(lang('Click here if you\'re not automatically redirected...'));

		echo '<html>' . "\n";
		echo '<head><title>'.lang('Processing Payment...').'</title></head>' . "\n";
		echo '<body onLoad="document.forms[\'paypal_auto_form\'].submit();">' . "\n";
		echo '<p>'.lang('Please wait, your order is being processed and you will be redirected to the paypal website.').'</p>' . "\n";
	...
	public function validate_ipn()
	{
		...
		else 
		{
			...
			$this->last_error = lang('IPN Validation Failed.');
			$this->log_ipn_results(false);	
			return false;
		}
	}
