        <h2 style="vertical-align:middle">
          <img alt="" class="nb" src="<?php echo base_url(); ?>assets/images/icons/help_32.png">
        ...
        <form action="<?php echo site_url('user/forgot_password'); ?>" method="post">
          ...
          <p>
            ...
            <?php echo generate_submit_button(lang('Get New Password'), base_url().'assets/images/icons/security_16.png'); ?><br>
          </p>
        </form>
