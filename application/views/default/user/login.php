        ...
        <div id="login">
          <form action="<?php echo site_url('user/login'); ?>" method="post" class="loginform">
            ...
            <p>
              ...
              <input style="background:2px center url(<?php echo base_url(); ?>assets/images/icons/user_16.png) no-repeat transparent; padding-left:22px" type="text" id="username_1" name="username">
              <label for="password_1"><strong><?php echo lang('Password:')?></strong></label>
              <input style="background:2px center url(<?php echo base_url(); ?>assets/images/other/key_16.png) no-repeat transparent; padding-left:22px" type="password" id="password_1" name="password"><br><br>
