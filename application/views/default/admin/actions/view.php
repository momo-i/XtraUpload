        ...
        <p class="action">
          ...
          <?php echo generate_link_button(lang('View PHPINFO Page'), site_url('admin/actions/php_info'), base_url().'assets/images/icons/about_16.png', NULL, array('rel' => 'external', 'target' => '_blank')); ?> 
        </p>
        <br><br>
        ...
        <p class="action">
          ...
          <?php echo generate_link_button(lang('Clear Site/Settings Cache'), site_url('admin/actions/clear_cache'), base_url().'assets/images/icons/trash_16.png', NULL); ?> 
        </p>
        <br><br>
        ...
        <p class="action">
          ...
          <?php echo generate_link_button(lang('Run Site Cron'), site_url('admin/actions/run_cron'), base_url().'assets/images/icons/history_16.png', NULL); ?> 
        </p>
        <br><br>
        ...
        <p class="action">
          ...
          <?php echo generate_link_button(lang('Sync Server Settings'), site_url('admin/actions/update_server_cache'), base_url().'assets/images/icons/sync_16.png', NULL); ?> 
        </p>
        <br><br>
