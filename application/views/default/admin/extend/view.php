        <h2 style="vertical-align:middle">
          <img src="<?php echo base_url(); ?>assets/images/icons/component_32.png" class="nb" alt="">
          <?php echo lang('Plugin Manager'); ?> 
        </h2>
        <?php echo $flash_message; ?> 
        <h3>
          <img src="<?php echo base_url(); ?>assets/images/icons/connect_16.png" class="nb" alt="">
...
<?php
	...
	{
?>
              <?php echo anchor('admin/extend/turn_off/'.$name, '<img src="'.base_url().'assets/images/icons/on_16.png" alt="" class="">'); ?> 
<?php
	}
	else
	{
?>
              <?php echo anchor('admin/extend/turn_on/'.$name, '<img src="'.base_url().'assets/images/icons/off_16.png" alt="" class="">'); ?> 
<?php
	}
...
?>
              <?php echo anchor('admin/extend/remove/'.$name, '<img src="'.base_url().'assets/images/icons/trash_16.png" alt="" class="nb">'); ?>
            </td>
          </tr>
<?php
}
?>
        ...
        <h3>
          <img src="<?php echo base_url(); ?>assets/images/icons/disconnect_16.png" class="nb" alt="">
...
?>
          <tr <?php echo alternator('class="odd"', 'class="even"'); ?>>
            ...
            <td><?php echo str_replace("\n", '<br>', word_wrap($plugin->description, 60)); ?></td>
            <td class="align-right">
                <?php echo anchor($plugin->link, '<img src="'.base_url().'assets/images/icons/link_16.png" alt="" class="nb">', array('rel' => 'external', 'title' => lang('Visit Plugin Home Page'))); ?> 
                <?php echo anchor('admin/extend/install/'.$name, '<img src="'.base_url().'assets/images/icons/wizard_16.png" alt="" class="nb">', array('title' => lang('Install Plugin'))); ?> 
            </td>
          </tr>
<?php
}
