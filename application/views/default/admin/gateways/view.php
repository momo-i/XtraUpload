        <h2 style="vertical-align:middle">
          <img src="<?php echo base_url(); ?>assets/images/icons/credit_card_32.png" class="nb" alt="">
...
?>
              <a title="<?php echo lang('Disable Gateway'); ?>" href="<?php echo site_url('admin/gateways/turn_off/'.$gate->id); ?>">
                <img src="<?php echo base_url(); ?>assets/images/icons/on_16.png" class="nb" alt="<?php echo lang('Disable'); ?>">
              </a>
<?php
	}
	else
...
?>
              <a title="<?php echo lang('Enable Gateway'); ?>" href="<?php echo site_url('admin/gateways/turn_on/'.$gate->id); ?>">
                <img src="<?php echo base_url(); ?>assets/images/icons/off_16.png" class="nb" alt="<?php echo lang('Enable'); ?>">
              </a>
<?php
	}
	if($gate->default)
	{
?>
              <img src="<?php echo base_url(); ?>assets/images/icons/certificate_16.png" class="nb" alt="<?php echo lang('Current Default!'); ?>">
<?php
	}
	else
	{
?>
              <a title="<?php echo lang('Set To Default'); ?>" href="<?php echo site_url('admin/gateways/set_default/'.$gate->id); ?>">
                <img src="<?php echo base_url();?>assets/images/icons/new_16.png" class="nb" alt="<?php echo lang('Set To Default'); ?>">
              </a>
<?php
	}
?>
