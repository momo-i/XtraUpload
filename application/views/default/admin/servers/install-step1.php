        ...
        <div style="border:1px #666666 solid">
          <h3 style="padding-top:0">
            <img src="<?php echo base_url(); ?>/assets/images/icons/warning_24.png" class="nb" alt="">
        ...
        <form action="<?php echo site_url('/admin/server/install/'.$sid); ?>" method="post"> 
          ...
          <p>
            <?php echo generate_submit_button(lang('Install Server Software'), base_url().'assets/images/icons/ok_16.png'); ?><br>
          </p>
        </form>
