        ...
        <form action="<?php echo site_url('admin/files/edit/'.$id); ?>" method="post">
          ...
          <p>
            <?php echo generate_link_button(lang('Manage Files'), site_url('admin/files/view'), base_url().'assets/images/icons/back_16.png'); ?><br><br>
...
?>
            ...
            <br><br>
            <?php echo generate_submit_button(lang('Edit'), base_url().'assets/images/icons/edit_16.png'); ?>
          </p>
        </form>
