        ...
        <div class="users">
          ...
          <div id="massActions" style="clear:both; padding-top:4px;">
            <div class="float-right">
              <?php echo generate_link_button(lang('New Group'), site_url('admin/group/add'), base_url().'assets/images/icons/add_16.png', NULL); ?>
            </div>
          </div>
...
?>
                  <a href="<?php echo site_url('admin/group/turn_off/'.$group->id); ?>">
                    <img src="<?php echo base_url(); ?>assets/images/icons/on_16.png" class="nb" alt="public" title="<?php echo lang('Make Private'); ?>">
                  </a>
<?php
		}
		else
...
?>
                  <a href="<?php echo site_url('admin/group/turn_on/'.$group->id); ?>">
                    <img src="<?php echo base_url(); ?>assets/images/icons/off_16.png" class="nb" alt="private" title="<?php echo lang('Make Public'); ?>">
                  </a>
<?php
		}
	}
