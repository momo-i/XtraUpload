        ...
        <br>
        <?php echo $error; ?>
        <?php echo generate_link_button(lang('Manage Users'), site_url('admin/user/home'), base_url().'assets/images/icons/back_16.png'); ?><br>
...
?>
            ...
            <?php echo generate_submit_button(lang('Add User'), base_url().'assets/images/icons/ok_16.png', 'green'); ?><br>
          </p>
        </form>
