        ...
        <form action="<?php echo site_url('files/get/'.$file->file_id.'/'.$file->link_name); ?>" method="post">
          ...
          <p>
            ...
            <code>
              ...
              <input style="background: url('<?php echo base_url(); ?>assets/images/icons/security_16.png') 2px center no-repeat; padding-left:20px;" type="text" size="40" maxlength="32" name="pass"><br><br>
              <?php echo generate_submit_button(lang('Unlock File'), base_url().'assets/images/icons/security_16.png', 'green')?><br>
            </code>
          </p>
        </form>
