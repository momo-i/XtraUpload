...
var chart = c3.generate({
  ...
  data: {
    ...
    columns: [
      ...
      ['<?php echo lang('All downloads'); ?>', <?php echo $day6['num']; ?>, <?php echo $day5['num']; ?>, <?php echo $day4['num']; ?>, <?php echo $day3['num']; ?>, <?php echo $day2['num']; ?>, <?php echo $day1['num']; ?>, <?php echo $today['num']; ?>]
    ],
