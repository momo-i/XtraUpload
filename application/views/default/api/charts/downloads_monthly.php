...
<chart caption='<?php echo lang('Past 7 Days Downloads'); ?>' xAxisName='<?php echo lang('Day'); ?>' yAxisName='<?php echo lang('Uploads'); ?>' showValues='0' decimals='0' formatNumberScale='0'>
