      ...
      <ul>
        ...
        <li class="complete">
          <a href="<?php echo site_url('install/step/3') ?>">
            <img src="<?php echo site_url() ?>img/icons/ok_16.png" border="0" alt="<?php printf(lang('Step %d'), 3); ?>">
        ...
        <li class="complete">
          <a href="<?php echo site_url('install/step/4') ?>">
            <img src="<?php echo site_url() ?>img/icons/ok_16.png" border="0" alt="<?php printf(lang('Step %d'), 4); ?>">
            <?php printf(lang('Step %d'), 3); ?> 
          </a>
        </li>
        <li class="current">
    ...
    <form id="form1" name="form1" method="post" enctype="multipart/form-data" action="<?php echo site_url('install/step/3'); ?>">
      <div class="centerbox">
