    ...
    <div class="progressMenu">
      <ul>
        <li class="current">
          <img src="<?php echo base_url(); ?>assets/images/icons/about_16.png" border="0" alt="<?php printf(lang('Step %d'), 1); ?>">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
          <tr>
            <td width="12%" valign="middle" style="text-align:middle">
              <img style="vertical-align:middle;" src="<?php echo base_url(); ?>assets/images/install/angle/install.png" width="128" height="128">
            </td>
            <td width="88%">
              <p class="style2">
          ...
          <div style="float:left">
            <span class="cssbutton">
              <a class="buttonRed" href="<?php echo site_url('install/setup'); ?>">
                <img src="<?php echo base_url(); ?>assets/images/icons/back_16.png" border="0" alt=""><?php echo lang('Go Back'); ?>
