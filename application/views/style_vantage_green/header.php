...
<html lang="<?php echo get_language($this->startup->locale); ?>">
  <head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="<?php echo base_url(); ?>assets/css/style_vantage_green/style_vantage_green.css">
